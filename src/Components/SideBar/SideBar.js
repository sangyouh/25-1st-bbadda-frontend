...
class SideBar extends Component {
  ...
  render() {
    const { price, discount, onClick } = this.props;
        ...
        >
          <div className="paymentInfo">
            ...
            <div className="infoList">
              ...
              <span className="discountInfo">-{discount}원</span>
            </div>
            <div className="infoList">
          ...
          <div className="priceInfo">
            <div className="infoList">
              ...
              <span className="totalPrice">{price}원</span>
            </div>
            <div className="mileageInfo">
              <span>적립예상 마일리지</span>
              <span className="savedMileage">({price}*0.1)원</span>
            </div>
          </div>
